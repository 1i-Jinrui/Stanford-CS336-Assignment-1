...
def train_quality_classifier(
    ...
    **kwargs
    ...
    if val_path and Path(val_path).exists():
        ...
        print(f"验证集结果: 样本数={result[0]}, Precision={result[1]}, Recall={result[2]}")
...
def main():
    ...
    # 文件路径
    positive_file = r"D:\Desktop\Stanford-CS336\Assignment-4\local-shared-data\quality_classify_dataset\wiki_positive_samples.txt"
    negative_file = r"D:\Desktop\Stanford-CS336\Assignment-4\local-shared-data\quality_classify_dataset\wiki_negative_samples.txt"
    merged_file = r"D:\Desktop\Stanford-CS336\Assignment-4\local-shared-data\quality_classify_dataset\quality_train_merged.txt"
    train_file = r"D:\Desktop\Stanford-CS336\Assignment-4\local-shared-data\quality_classify_dataset\quality_train.txt"
    val_file = r"D:\Desktop\Stanford-CS336\Assignment-4\local-shared-data\quality_classify_dataset\quality_val.txt"
    model_path = r"D:\Desktop\Stanford-CS336\Assignment-4\local-shared-data\quality_classifier.bin"
